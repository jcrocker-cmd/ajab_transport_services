                        ...
                        <hr class="bg-dark">
                            ...
                            <div class="d-flex align-items-center mode-of-delivery mx-0">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="mode_del" id="opt1" value="Airport" data-delivery-price="500" required>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="mode_del" id="opt2" value="Cebu City" data-delivery-price="300">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="mode_del" id="opt3" value="Mandaue City" data-delivery-price="350">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="mode_del" id="opt4" value="Talisay City" data-delivery-price="500">
                ...
                <div class="sect-2">
                    ...
                    <div class="price-info">
                        ...
                        <div style="width: 100%;" hidden>
                            ...
                            <input type="text" id="total_rates_input" name="total_days" value="0">
                        </div>
