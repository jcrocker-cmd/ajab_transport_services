...
@section('content')
  ...
  <div class="sidebar" id="side_nav">
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      <li class="active"><a href="/available" class="text-decoration-none px-3 py-2 d-block"><i class="far fa-car" style="margin-right: 10px;"></i>   Available Cars</a></li>
  ...
  <div id="dashboard-content">
    ...
    @include('dashboard.components.available-cars-content')
</div>
