...
@section('styles')
  ...
  <div class="sidebar" id="side_nav">
    ...
    <ul class ="list-unstyled px-2">
      ...
      <li class="active"><a href="/rented" class="text-decoration-none px-3 py-2 d-block"><i class="far fa-car-building"></i>   Rented Cars</a></li>
  ...
  @section('content')
    @include('dashboard.components.rented-cars-content')
