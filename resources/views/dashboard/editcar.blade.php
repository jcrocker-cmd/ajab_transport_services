...
@section('content')
  ...
  <div class="sidebar" id="side_nav">
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      <li class="active"><a href="/all-vehicles" class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list" style="margin-right: 10px;"></i>   Registered Cars</a></li>
  ...
  <div id="dashboard-content">
    ...
    @include('dashboard.components.editcar-content')
</div>
