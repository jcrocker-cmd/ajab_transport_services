...
@section('content')
  ...
  <div class="sidebar" id="side_nav">
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      @endrole
      <li class="active"><a href="/allusers" class="text-decoration-none px-3 py-2 d-block"><i class="far fa-users" style="margin-right: 10px;"></i>   Customers</a></li>
  ...
  <div id="dashboard-content">
    ...
    @include('dashboard.components.viewuser-content')
</div>
